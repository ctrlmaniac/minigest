...
`),m.rippleVisible,ht,re,({theme:e})=>e.transitions.easing.easeInOut,m.ripplePulsate,({theme:e})=>e.transitions.duration.shorter,m.child,m.childLeaving,mt,re,({theme:e})=>e.transitions.easing.easeInOut,m.childPulsate,bt,({theme:e})=>e.transitions.easing.easeInOut),Rt=i.forwardRef(function(t,r){const u=Te({props:t,name:"MuiTouchRipple"}),{center:n=!1,classes:o={},className:s}=u,c=oe(u,ft),[l,p]=i.useState([]),d=i.useRef(0),g=i.useRef(null);i.useEffect(()=>{g.current&&(g.current(),g.current=null)},[l]);const b=i.useRef(!1),V=i.useRef(null),h=i.useRef(null),y=i.useRef(null);i.useEffect(()=>()=>{clearTimeout(V.current)},[]);const I=i.useCallback(f=>{const{pulsate:R,rippleX:E,rippleY:k,rippleSize:_,cb:K}=f;p(T=>[...T,O(yt,{classes:{ripple:C(o.ripple,m.ripple),rippleVisible:C(o.rippleVisible,m.rippleVisible),ripplePulsate:C(o.ripplePulsate,m.ripplePulsate),child:C(o.child,m.child),childLeaving:C(o.childLeaving,m.childLeaving),childPulsate:C(o.childPulsate,m.childPulsate)},timeout:re,pulsate:R,rippleX:E,rippleY:k,rippleSize:_},d.current)]),d.current+=1,g.current=K},[o]),$=i.useCallback((f={},R={},E=()=>{})=>{const{pulsate:k=!1,center:_=n||R.pulsate,fakeElement:K=!1}=R;if((f==null?void 0:f.type)==="mousedown"&&b.current){b.current=!1;return}(f==null?void 0:f.type)==="touchstart"&&(b.current=!0);const T=K?null:y.current,P=T?T.getBoundingClientRect():{width:0,height:0,left:0,top:0};let x,B,L;if(_||f===void 0||f.clientX===0&&f.clientY===0||!f.clientX&&!f.touches)x=Math.round(P.width/2),B=Math.round(P.height/2);else{const{clientX:D,clientY:v}=f.touches&&f.touches.length>0?f.touches[0]:f;x=Math.round(D-P.left),B=Math.round(v-P.top)}if(_)L=Math.sqrt((2*P.width**2+P.height**2)/3),L%2===0&&(L+=1);else{const D=Math.max(Math.abs((T?T.clientWidth:0)-x),x)*2+2,v=Math.max(Math.abs((T?T.clientHeight:0)-B),B)*2+2;L=Math.sqrt(D**2+v**2)}f!=null&&f.touches?h.current===null&&(h.current=()=>{I({pulsate:k,rippleX:x,rippleY:B,rippleSize:L,cb:E})},V.current=setTimeout(()=>{h.current&&(h.current(),h.current=null)},dt)):I({pulsate:k,rippleX:x,rippleY:B,rippleSize:L,cb:E})},[n,I]),U=i.useCallback(()=>{$({},{pulsate:!0})},[$]),N=i.useCallback((f,R)=>{if(clearTimeout(V.current),(f==null?void 0:f.type)==="touchend"&&h.current){h.current(),h.current=null,V.current=setTimeout(()=>{N(f,R)});return}h.current=null,p(E=>E.length>0?E.slice(1):E),g.current=R},[]);return i.useImperativeHandle(r,()=>({pulsate:U,start:$,stop:N}),[U,$,N]),O(gt,X({className:C(m.root,o.root,s),ref:y},c,{children:O(lt,{component:null,exit:!0,children:l})}))}),Et=Rt;function Tt(e){return ze("MuiButtonBase",e)}const Mt=Ee("MuiButtonBase",["root","disabled","focusVisible"]),Ct=Mt,xt=["action","centerRipple","children","className","component","disabled","disableRipple","disableTouchRipple","focusRipple","focusVisibleClassName","LinkComponent","onBlur","onClick","onContextMenu","onDragLeave","onFocus","onFocusVisible","onKeyDown","onKeyUp","onMouseDown","onMouseLeave","onMouseUp","onTouchEnd","onTouchMove","onTouchStart","tabIndex","TouchRippleProps","touchRippleRef","type"],vt=e=>{const{disabled:t,focusVisible:r,focusVisibleClassName:u,classes:n}=e,s=Xe({root:["root",t&&"disabled",r&&"focusVisible"]},Tt,n);return r&&u&&(s.root+=` ${u}`),s},wt=se("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(e,t)=>t.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${Ct.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),Vt=i.forwardRef(function(t,r){const u=Te({props:t,name:"MuiButtonBase"}),{action:n,centerRipple:o=!1,children:s,className:c,component:l="button",disabled:p=!1,disableRipple:d=!1,disableTouchRipple:g=!1,focusRipple:b=!1,LinkComponent:V="a",onBlur:h,onClick:y,onContextMenu:I,onDragLeave:$,onFocus:U,onFocusVisible:N,onKeyDown:f,onKeyUp:R,onMouseDown:E,onMouseLeave:k,onMouseUp:_,onTouchEnd:K,onTouchMove:T,onTouchStart:P,tabIndex:x=0,TouchRippleProps:B,touchRippleRef:L,type:D}=u,v=oe(u,xt),j=i.useRef(null),M=i.useRef(null),Me=de(M,L),{isFocusVisibleRef:le,onFocus:Ce,onBlur:xe,ref:ve}=tt(),[F,Y]=i.useState(!1);p&&F&&Y(!1),i.useImperativeHandle(n,()=>({focusVisible:()=>{Y(!0),j.current.focus()}}),[]);const[J,we]=i.useState(!1);i.useEffect(()=>{we(!0)},[]);const Ve=J&&!d&&!p;i.useEffect(()=>{F&&b&&!d&&J&&M.current.pulsate()},[d,b,F,J]);function w(a,pe,je=g){return H(fe=>(pe&&pe(fe),!je&&M.current&&M.current[a](fe),!0))}const Pe=w("start",E),Be=w("stop",I),Le=w("stop",$),ke=w("stop",_),De=w("stop",a=>{F&&a.preventDefault(),k&&k(a)}),Fe=w("start",P),Se=w("stop",K),$e=w("stop",T),Ne=w("stop",a=>{xe(a),le.current===!1&&Y(!1),h&&h(a)},!1),_e=H(a=>{j.current||(j.current=a.currentTarget),Ce(a),le.current===!0&&(Y(!0),N&&N(a)),U&&U(a)}),Q=()=>{const a=j.current;return l&&l!=="button"&&!(a.tagName==="A"&&a.href)},Z=i.useRef(!1),Oe=H(a=>{b&&!Z.current&&F&&M.current&&a.key===" "&&(Z.current=!0,M.current.stop(a,()=>{M.current.start(a)})),a.target===a.currentTarget&&Q()&&a.key===" "&&a.preventDefault(),f&&f(a),a.target===a.currentTarget&&Q()&&a.key==="Enter"&&!p&&(a.preventDefault(),y&&y(a))}),Ie=H(a=>{b&&a.key===" "&&M.current&&F&&!a.defaultPrevented&&(Z.current=!1,M.current.stop(a,()=>{M.current.pulsate(a)})),R&&R(a),y&&a.target===a.currentTarget&&Q()&&a.key===" "&&!a.defaultPrevented&&y(a)});let W=l;W==="button"&&(v.href||v.to)&&(W=V);const z={};W==="button"?(z.type=D===void 0?"button":D,z.disabled=p):(!v.href&&!v.to&&(z.role="button"),p&&(z["aria-disabled"]=p));const Ue=de(r,ve,j),ce=X({},u,{centerRipple:o,component:l,disabled:p,disableRipple:d,disableTouchRipple:g,focusRipple:b,tabIndex:x,focusVisible:F}),Ke=vt(ce);return Ae(wt,X({as:W,className:C(Ke.root,c),ownerState:ce,onBlur:Ne,onClick:y,onContextMenu:Be,onFocus:_e,onKeyDown:Oe,onKeyUp:Ie,onMouseDown:Pe,onMouseLeave:De,onMouseUp:ke,onDragLeave:Le,onTouchEnd:Se,onTouchMove:$e,onTouchStart:Fe,ref:Ue,tabIndex:p?-1:x,type:D},z,v,{children:[s,Ve?O(Et,X({ref:Me,center:o},B)):null]}))}),Lt=Vt;export{Lt as B,me as T,nt as _,He as a,H as b,tt as c,Ye as s,de as u};
