...
@ToString
@NoArgsConstructor
public class F24SezioneAltriEnti {
	...
	public F24SezioneAltriEnti(F24 f24, String codiceEnte, String codiceSede, String causaleContributo,
			String codicePosizione, String meseRiferimentoDa, String annoRiferimentoDa, String meseRiferimentoA,
			String annoRiferimentoA, double importoDebito, double importoCredito) {
		this.f24 = f24;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		F24SezioneAltriEnti other = (F24SezioneAltriEnti) obj;
		if (id == null) {
			if (other.id != null)
				return false;
