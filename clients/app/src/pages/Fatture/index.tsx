...
const Fatture: React.FC = () => {
  ...
  if (mode !== "acquisto" && mode !== "vendita") {
    return <ErrorScreen message="Pagina non trovata!" />;
  } else {
    return (
      <>
        <Box mb={3}>
        ...
        {isEmpty(selected) ? (
          <Box mb={3}>
            <Alert severity="error" variant="outlined">
              ...
              Per visualizzare le fatture devi prima selezionare un'azienda!
              Clicca sull'icona in alto a sinistra <IconBuildingWarehouse /> per
              selezionarne una!
            </Alert>
          </Box>
        ) : (
